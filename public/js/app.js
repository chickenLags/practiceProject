...
/* harmony import */ var _modules_Battle_Battle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/Battle/Battle */ "./resources/js/modules/Battle/Battle.js");
// require('./bootstrap');
...
if (window.location.pathname === '/battle') {
  ...
  fetch("/api/battle/".concat(playerId), {
    headers: {
    ...
    if (!battleData.battle) {
      // notify no battle
      _modules_Battle_Battle__WEBPACK_IMPORTED_MODULE_0__.default.noBattle();
      return;
    }
...
/***/ "./resources/js/modules/Battle/Battle.js":
/*!***********************************************!*\
  !*** ./resources/js/modules/Battle/Battle.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _Monster__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Monster */ "./resources/js/modules/Battle/Monster.js");
/* harmony import */ var _Player__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Player */ "./resources/js/modules/Battle/Player.js");
/* harmony import */ var _Time__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Time */ "./resources/js/modules/Time.js");
/* harmony import */ var _CombatNotification__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./CombatNotification */ "./resources/js/modules/Battle/CombatNotification.js");
/* harmony import */ var _CombatMenu__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./CombatMenu */ "./resources/js/modules/Battle/CombatMenu.js");
...
var Battle = /*#__PURE__*/function () {
  function Battle(battleData) {
    ...
    _defineProperty(this, "delayBetweenTurns", 1500);
  ...
  _createClass(Battle, [{
    ...
    key: "handleBattleLost",
    value: function handleBattleLost() {//TODO: implement function
    ...
    key: "escape",
    value: function escape() {//TODO: implement function, maybe? can i handle this with skills or so?
    }
  }], [{
    key: "noBattle",
    value: function noBattle() {
      this.clearBattleScreen();
      this.putTextInMiddleOfBattleScreen('You are not in a battle');
    }
  }, {
    key: "clearBattleScreen",
    value: function clearBattleScreen() {
      var battleContainer = document.querySelector('.battle-container');
      Array.from(battleContainer.children).forEach(function (child) {
        return battleContainer.removeChild(child);
      });
    }
  }, {
    key: "putTextInMiddleOfBattleScreen",
    value: function putTextInMiddleOfBattleScreen(text) {
      var battleContainer = document.querySelector('.battle-container');
      var shooText = document.createTextNode('You are not in a battle. Shoo...');
...
/***/ "./resources/js/modules/Battle/CombatAction.js":
/*!*****************************************************!*\
  !*** ./resources/js/modules/Battle/CombatAction.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Time__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Time */ "./resources/js/modules/Time.js");
...
var CombatAction = /*#__PURE__*/function () {
  // 'attack' / 'water' / 'steal', 'potion',
  // player, monster
  // player, monster
  // magic, physical, ranged
  // item, combat, utility
  //true/false
  function CombatAction(name, origin, target) {
    var actionType = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'combat';
    var combatType = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'physical';
    var isHeal = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : false;

    _classCallCheck(this, CombatAction);
    ...
    _defineProperty(this, "combatType", void 0);

    _defineProperty(this, "actionType", void 0);

    _defineProperty(this, "isMagic", void 0);
  ...
  _createClass(CombatAction, [{
    key: "handle",
    value: function () {
      var _handle = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(messageCallback) {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _context.abrupt("return", this.heal());
              ...
              case 2:
                ...
                return _context.abrupt("return", this.custom());

              case 4:
                _context.next = 6;
                return this.handleCombat(messageCallback);
    ...
    key: "handleCombat",
    value: function () {
      var _handleCombat = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(messageCallback) {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
              ...
              case 2:
                ...
                messageCallback("".concat(this.target.getName(), " did a swirly shwoo. ").concat(this.origin.getName(), "'s ").concat(this.name, " missed."));
                _context2.next = 6;
                return this.target.dodgeAnimation(800);
              ...
              case 7:
                ...
                _context2.next = 12;
                return this.origin.attackAnimation(500);
      ...
      function handleCombat(_x2) {
        return _handleCombat.apply(this, arguments);
      }
    ...
    value: function getDamage() {
      switch (this.combatType) {
        case 'magic':
          return this.origin.stats.spirit * 3;

        case 'physical':
          return this.origin.stats.strength * 2;

        case 'range':
          return this.origin.agility * 1.5;

        default:
          throw new Error('unknown combat type given in CombatAction.getDamage.');
      }
    }
  }, {
    key: "getDefence",
    value: function getDefence() {
      switch (this.combatType) {
        case 'magic':
          return this.origin.stats.wisdom * 3;

        case 'physical':
          return this.origin.stats.vitality * 2;
    ...
    key: "getDefencePercentage",
    value: function getDefencePercentage(damage, defence) {
      return (damage - defence) / damage;
    }
  }, {
    key: "hitsEnemy",
    value: function hitsEnemy() {
      var percentageDiff = (this.target.stats.evasion - this.origin.stats.hit_rate) / this.origin.stats.hit_rate;
      return Math.random() <= 1 + percentageDiff;
    }
  }, {
    key: "handleUtility",
    value: function handleUtility() {}
  }, {
    key: "handleHeal",
    value: function handleHeal() {}
  }, {
    key: "getMagicDamage",
    value: function getMagicDamage(entityStats) {
      return this.spirit * this.spell.getDamage();
    }
  }, {
    key: "itemDamage",
    value: function itemDamage(entityStats) {}
  }]);

  return CombatAction;
}();

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CombatAction);

/***/ }),

/***/ "./resources/js/modules/Battle/CombatMenu.js":
/*!***************************************************!*\
  !*** ./resources/js/modules/Battle/CombatMenu.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Action = function Action(name, callback) {
...
var CombatMenu = /*#__PURE__*/function () {
  ...
  function CombatMenu(battle, player) {
    ...
    _classCallCheck(this, CombatMenu);

    _defineProperty(this, "battle", void 0);
  ...
  _createClass(CombatMenu, [{
    ...
    key: "clearBattleMenu",
    value: function clearBattleMenu() {
      var _this2 = this;

      Array.from(this.element.children).forEach(function (child) {
        return _this2.element.removeChild(child);
      });
    }
  }, {
    key: "show",
...
/***/ "./resources/js/modules/Battle/CombatNotification.js":
/*!***********************************************************!*\
  !*** ./resources/js/modules/Battle/CombatNotification.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var CombatNotification = /*#__PURE__*/function () {
  function CombatNotification() {
    _classCallCheck(this, CombatNotification);
  ...
  _createClass(CombatNotification, [{
    key: "show",
    value: function () {
      var _show = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(message) {
        var duration,
            _args = arguments;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                this.element.classList.add('active');
                _context.next = 5;
                return _Time__WEBPACK_IMPORTED_MODULE_1__.default.sleep(duration);
  ...
  return CombatNotification;
}();

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CombatNotification);

/***/ }),

/***/ "./resources/js/modules/Battle/EntityBattleDisplay.js":
/*!************************************************************!*\
  !*** ./resources/js/modules/Battle/EntityBattleDisplay.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var EntityDisplayBattle = /*#__PURE__*/function () {
  function EntityDisplayBattle() {
    var entity = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'enemy';

    _classCallCheck(this, EntityDisplayBattle);

    this.statsWindow = document.querySelector(".".concat(entity, "-stats"));
    ...
    this.imageContainer = document.querySelector(".".concat(entity, "-self"));
    this.entityImage = this.imageContainer.querySelector('img');
  }

  _createClass(EntityDisplayBattle, [{
    key: "setTitle",
    value: function setTitle() {
      var titleValue = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'Lvl.?? - Unknown';
      this.titleElm.innerText = titleValue;
    }
  }, {
    key: "setHpBar",
    value: function setHpBar(value, max) {
      var percentageHealth = value / max;

      if (percentageHealth < 0) {
        percentageHealth = 0;
      }

      this.currentHealthBar.style.transform = "scale(".concat(percentageHealth, ", 1)");
    }
  }, {
    key: "setImageSrc",
    value: function setImageSrc(url) {
      this.entityImage.src = url;
    }
  }, {
    key: "attackAnimation",
    value: function () {
      var _attackAnimation = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
        var duration,
            _args = arguments;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                duration = _args.length > 0 && _args[0] !== undefined ? _args[0] : 1000;
      ...
      function attackAnimation() {
        return _attackAnimation.apply(this, arguments);
      }
    ...
    key: "dodgeAnimation",
    value: function () {
      var _dodgeAnimation = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
        var duration,
            _args2 = arguments;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                duration = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : 1000;
      ...
      function dodgeAnimation() {
        return _dodgeAnimation.apply(this, arguments);
      }
  ...
  return EntityDisplayBattle;
}();

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (EntityDisplayBattle);
...
var Monster = /*#__PURE__*/function (_CombatEntity) {
  _inherits(Monster, _CombatEntity);

  var _super = _createSuper(Monster);

  function Monster(monsterData, refToBattle) {
    var _this;
    ...
    _defineProperty(_assertThisInitialized(_this), "fillable", ['name', 'image_url']);

    _defineProperty(_assertThisInitialized(_this), "stats", void 0);

    _defineProperty(_assertThisInitialized(_this), "statDisplay", void 0);

    _defineProperty(_assertThisInitialized(_this), "entityType", 'enemy');
...
/***/ "./resources/js/modules/Battle/Player.js":
/*!***********************************************!*\
  !*** ./resources/js/modules/Battle/Player.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Player = /*#__PURE__*/function (_CombatEntity) {
  ...
  function Player(playerData, refToBattle) {
    var _this;
    ...
    _defineProperty(_assertThisInitialized(_this), "image_url", void 0);
...
/***/ "./resources/js/modules/Battle/Stats.js":
/*!**********************************************!*\
  !*** ./resources/js/modules/Battle/Stats.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Stats = function Stats(statData) {
  _classCallCheck(this, Stats);

  _defineProperty(this, "fillable", ['level', 'hp', 'strength', // dmg aplifier
...
/***/ "./resources/js/modules/Battle/combatEntity.js":
/*!*****************************************************!*\
  !*** ./resources/js/modules/Battle/combatEntity.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var CombatEntity = /*#__PURE__*/function () {
  // stats;
  // statDisplay;
  function CombatEntity(refToBattle) {
    _classCallCheck(this, CombatEntity);

    _defineProperty(this, "fillable", ['name', 'image_url', 'x', 'y']);

    _defineProperty(this, "image_url", void 0);

    _defineProperty(this, "entityType", 'player');

    this.refToBattle = refToBattle;
  }

  _createClass(CombatEntity, [{
    key: "populateData",
    value: function populateData(combatEntityData) {
      this.populateGeneralData(combatEntityData);
      this.populateStats(combatEntityData);
      this.populateStatDisplay(combatEntityData);
    }
  }, {
    key: "populateGeneralData",
    value: function populateGeneralData(combatEntityData) {
      var _this = this;

      var keys = Object.keys(combatEntityData);
      var legalKeys = this.fillable.intersect(keys);
      legalKeys.forEach(function (key) {
        return _this[key] = combatEntityData[key];
      });
    }
  }, {
    key: "populateStats",
    value: function populateStats(combatEntityData) {
      this.stats = new _Stats__WEBPACK_IMPORTED_MODULE_1__.default(combatEntityData);
    }
  }, {
    key: "populateStatDisplay",
    value: function populateStatDisplay(combatEntityData) {
      this.statDisplay = new _EntityBattleDisplay__WEBPACK_IMPORTED_MODULE_2__.default(this.entityType);
      this.statDisplay.setTitle("Lvl. ".concat(this.stats.level, " - ").concat(this.getName()));
    ...
    key: "attackAnimation",
    value: function () {
      var _attackAnimation = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(duration) {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.statDisplay.attackAnimation(duration);
    ...
    key: "dodgeAnimation",
    value: function () {
      var _dodgeAnimation = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(duration) {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return this.statDisplay.dodgeAnimation(duration);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CombatEntity);
